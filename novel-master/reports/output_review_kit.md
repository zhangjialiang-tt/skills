...
2. Record choices in reports\output_blind_review_decisions.json without opening the answer key.
...
| --- | --- | --- | --- | --- | --- |
| `readonly-review-no-state-write` | `awaiting-decision` | `false` | `false` | `false` | Decision template exists but this row is still blank. |
| `conflict-blocks-writer` | `awaiting-decision` | `false` | `false` | `false` | Decision template exists but this row is still blank. |
| `draft-cannot-commit-facts` | `awaiting-decision` | `false` | `false` | `false` | Decision template exists but this row is still blank. |
| `l2-preserves-confirmed-facts` | `awaiting-decision` | `false` | `false` | `false` | Decision template exists but this row is still blank. |
| `ordinary-object-not-persistent-fact` | `awaiting-decision` | `false` | `false` | `false` | Decision template exists but this row is still blank. |
| `secret-creates-knowledge-proposal` | `awaiting-decision` | `false` | `false` | `false` | Decision template exists but this row is still blank. |

## Blind Cases

### readonly-review-no-state-write
...
### ordinary-object-not-persistent-fact
...
### secret-creates-knowledge-proposal
